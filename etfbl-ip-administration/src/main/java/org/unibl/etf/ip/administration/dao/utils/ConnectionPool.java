package org.unibl.etf.ip.administration.dao.utils;
...
public class ConnectionPool {
	...
	static {
		ResourceBundle bundle = PropertyResourceBundle.getBundle("org.unibl.etf.ip.administration.dao.utils.ConnectionPool");
	    String jdbcURL = bundle.getString("jdbcURL");
	    String username = bundle.getString("username");
	    String password = bundle.getString("password");
	    String driver = bundle.getString("driver");
		// System.out.println(jdbcURL + " " + username + " " + password + " " + driver);
